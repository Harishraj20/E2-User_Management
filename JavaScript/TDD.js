...
const groupModal = document.querySelector('#addgroupModal');
...
addUserButton.addEventListener('click', () => {
    ...
    addUserForm.reset();
    document.querySelector('.formTitle h2').textContent = 'ADD USER FORM';
        ...
        const rows = users.map(user => `
            <tr>
                ...
                <td>
                    ...
                    <button class="delete-button" data-username="${user.username}">Delete</button>
                </td>
            </tr>
        `).join('');
...
function editUser(username) {
    ...
    document.querySelector('.formTitle h2').textContent = 'UPDATE USER';
    userModal.style.display = 'flex';
...
const deleteGroupButton = document.querySelector('.delete-group-button'); // Assuming there's a button for deletion
...
module.exports = {renderGroups,showAddRoleModal,
    closeAddRoleModal,
    addRole,
    renderRoles,
