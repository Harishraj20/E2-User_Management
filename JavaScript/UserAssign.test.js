...
describe('User MANAGEMENT HTML', () => {
    ...
    test('User Management Page Elements', () => {
        ...
        checkTextContent('.child1 .userbutton', 'User');
        checkTextContent('.child1 .groupbutton', 'Group');
        checkTextContent('.child1 .rolebutton', 'Role');
        ...
        checkTextContent('.UserTitle h2', 'USER MANAGEMENT');
        checkElementPresence('.userTable');
        checkTextContent('.listTitle h4', 'USERS LIST');
...
describe('GROUP MANAGEMENT HTML', () => {
    ...
    test('Group Management Page Elements', () => {
        ...
        checkTextContent('.grouplistTitle h4', 'Groups List');
...
test('To check the presence of roleTitle div with ROLES LIST', () => {
    ...
    const roleTitle = document.querySelector('.roleTitle .listTitle h4');
...
test('To check the presence of Role Assignment title', () => {
    const roleAssignmentTitle = document.querySelector('.roleToUserTitle h4');
...
describe('User Management Functionality', () => {
    ...
    const clickEditButton = (index) => {
        ...
        const text = document.querySelector('.formTitle h2');
    ...
    describe('To Check the functionality of Delete User', () => {
        ...
        // test.only('To check delete Button is clickable and modal Opens', () => {
        //     const clickHandler = jest.fn();
        //     const clickdeleteButton = document.querySelector('.delete-button');  
        //     testButtonClick(clickdeleteButton, clickHandler);
        //     const username = table.querySelectorAll('tr')[0].children[0].textContent;
        //     expect(confirmationModal.style.display).toBe('flex')
        //     expect(modalText.textContent).toBe(`Are you sure to delete the user '${username}'?`)
        // });
...
describe('Group Management Functionality', () => {
    ...
    test('should open Remove Modal and display the correct title', () => {
        ...
        const modalTitle = document.querySelector('.formTitleForDelete h2');
...
describe('Role Management Functionality', () => {
    ...
    beforeEach(() => {
        ({renderGroups,showAddRoleModal,
            ...
            handleAssignGroup,
            handleAssignRole,
            searchRoles, closeAddRoleModal} = require('./TDD.js')); 
...
describe('Role Management System', () => {
    ...
    ({renderGroups,showAddRoleModal,
        ...
        handleAssignGroup,
        handleAssignRole,
        searchRoles,handleAssignGroup, handleAssignRole, renderRoleAssignments, populateSelects , closeAddRoleModal,showAddRoleModal, closeAddRoleModal, addRole, renderRoles, searchRoles, handleAssignGroup, handleAssignRole} = require('./TDD.js')); 
    addRoleModal = document.querySelector('#addRoleModal');
    roleTableBody = document.querySelector('#roleTableBody');
    searchRoleInput = document.querySelector('#searchRole');
    addRoleForm = document.querySelector('#addRoleForm');
